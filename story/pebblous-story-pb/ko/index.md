---
title: 안녕하세요, 저는 페블러스입니다
subtitle: 데이터를 경작하는 딥테크 스타트업
date: 2026-03-30
category: story
source: index.html
...
> 저에게는 세 가지 능력이 있습니다. **DataClinic**으로 데이터의 건강을 진단하고, **Data Greenhouse**로 데이터를 경작하며, **PebbloSim**으로 현실보다 현실 같은 합성 데이터를 만듭니다. 18명의 작은 팀이지만, 특허 36건 이상을 보유하고 NVIDIA와 같은 영역에서 경쟁합니다.
...
Pebblous = Pebble + Fabulous

흩어진 데이터를 손에 잡히는 가치로 바꿉니다
...
현대자동차LG전자LGU+한화비전삼성E&A대한민국 육군대한민국 해병대

저는 18명의 팀입니다. 작습니다. 하지만 한국 특허 36건 이상, 미국 특허 4건 이상을 보유하고 있고, 과학기술정보통신부의 61억 원 규모 글로벌 빅테크 육성 과제를 주관하고 있습니다. CES 2024과 2025, MWC 2025에도 나갔습니다. 작은 몸집에 큰 발자국을 남기고 있습니다.

경쟁 구도

글로벌 시장에서 저와 비교되는 이름들은 **NVIDIA Isaac**(시뮬레이션), **Applied Intuition**(자율주행 데이터), **Snowflake/Databricks**(데이터 플랫폼)입니다. 하지만 데이터 진단 + 자율 운영 + 합성 생성을 하나로 통합한 플레이어는 저뿐입니다. 이것이 18명이 수천 명의 회사와 경쟁할 수 있는 이유입니다.

## 탄생 이야기

2021년 4월 1일, 만우절이었습니다. 이주행 박사가 이정원 박사에게 문자를 보냈습니다. "나 창업할 것 같애." 직접적인 권유가 아니었습니다. 그저 넌즈시 건넨 한 마디였습니다. 하지만 이정원 박사는 그 뜻을 알아챘습니다. 답은 한 단어였습니다. **"설렌다."** 이것이 저의 시작입니다.
...
<!-- stat-card -->
**창업자 프로필** — 이주행 (CEO) — POSTECH 컴퓨터공학 학사/석사/박사. ETRI 책임연구원 23년. 컴퓨터 그래픽스, 인간-로봇 상호작용, AI 연구. 가헌학술상 2회 수상. Wolfram Innovation Award 수상. 컴퓨터 과학자 최초 한국CDE학회 회장 역임. "데이터를 눈으로 볼 수 있다면"이라는 질문에서 출발. — 이정원 (COO) — 서울대학교 전기공학부 학사, 서울대 의공학 석사, KAIST 뇌공학 박사. ETRI 선임연구원. AI 영상 분석 소프트웨어 전문.
...
이주행 대표가 창업 준비 기간에 떠올린 아이디어가 있었습니다. 고차원 데이터를 기하학적 다양체(Geometric Manifold)로 변환하면, 데이터의 분포를 **눈으로 볼 수 있습니다**. 이것을 "Data Imaging"이라고 이름 붙였습니다. X-ray가 뼈를 보여주듯, Data Imaging은 데이터의 내부 구조를 보여줍니다.

2021년 11월, 두 사람은 ETRI를 떠나 페블러스를 창업했습니다. 창업 직전 이례적으로 TIPS 과제에 선정되었고, 창업과 함께 시드 투자를 유치했습니다. 그리고 창업 1년이 채 되지 않아 현대차 제로원을 포함한 투자사들로부터 Pre-A 투자를 유치했습니다.

![ETRI 한국전자통신연구원 본관 건물 전경 — 페블러스 창업자들이 23년간 연구한 대전 소재 정부출연연구기관](./image/img-01-etri-building.jpg)
*▲ ETRI(한국전자통신연구원) 본관 — 페블러스 창업자 두 명이 23년간 연구한 곳 | Source: [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:ETRI-1,_Korea.jpg)*

4.1

2021년 4월 1일 — 만우절 문자

이주행 → 이정원: "나 창업할 것 같애." / 이정원: "설렌다." 페블러스의 첫 번째 씨앗.

11

2021년 11월 — 법인 설립 · TIPS 선정 · 시드 투자

ETRI 출신 핵심 연구자들과 함께 (주)페블러스 창업. 창업 직전 이례적으로 TIPS 과제 선정. 창업과 함께 시드 투자 유치. "Make Data Tangible" 선언.

22

2022년 — Pre-A 투자 유치

창업 1년 이내에 현대차 제로원을 포함한 투자사들로부터 Pre-A 투자 유치.
...
CES 2024 참가. 과기정통부 61억 원 글로벌 빅테크 육성 과제 주관기관 선정.
...
**DataClinic**은 저의 첫 번째 제품이자, 저를 세상에 알린 기술입니다. 고차원 데이터를 기하학적 다양체 공간으로 변환해서, 데이터의 분포와 밀도를 시각적으로 보여줍니다. 의사가 X-ray로 뼈를 보듯, DataClinic은 데이터의 내부 구조를 봅니다. 저는 이것을 **DataLens**라고 부릅니다.

🔬📊🩺

DataClinic — 데이터의 건강검진

고차원 데이터를 매니폴드 공간에서 시각화하여 품질을 진단합니다
...
<!-- stat-card -->
**L1** — Level 1 — 기초 통계 진단 — 클래스 분포, 이미지 해상도, 밝기 분포, 기본 통계량. 데이터셋의 전체적인 건강 상태를 빠르게 확인합니다. 병원의 기본 혈액검사에 해당합니다.

<!-- stat-card -->
**L2** — Level 2 — DataLens 뉴럴넷 매니폴드 진단 — 뉴럴 네트워크가 학습한 매니폴드 공간에서 데이터 분포를 시각화합니다. 클래스 간 혼동 영역, 밀도 불균형, 이상치를 정밀하게 식별합니다. 시간당 10만 장 처리. MRI 수준의 정밀 검진입니다.

<!-- stat-card -->
**L3** — Level 3 — 커스텀 도메인 진단 — 고객의 특정 도메인(자동차 부품 결함, 방산 센서 데이터 등)에 맞춘 커스텀 진단. 도메인 전문가의 진료에 해당합니다.
...
▲ DataClinic 실제 진단 출력 — 산업 폐기물 데이터셋 Level2 밀도 지형도. 산의 높이가 데이터의 밀집도를 나타내며, 계곡(빈 공간)이 데이터 공백 영역입니다. 어디를 보강해야 할지가 한눈에 보입니다. | 📊 [산업 폐기물 DataClinic 전체 리포트 →](https://blog.pebblous.ai/story/dataclinic-report-131-industrialwaste-story-pb/ko/)

▲ DataClinic Level2 PCA 분석 — 각 클래스의 평균 특징 벡터를 2D 공간에 투영. 클래스 간 거리와 경계가 직관적으로 파악되어, AI가 혼동하기 쉬운 유사 클래스를 사전에 발견할 수 있습니다. | 📊 [산업 폐기물 DataClinic 전체 리포트 →](https://blog.pebblous.ai/story/dataclinic-report-131-industrialwaste-story-pb/ko/)

실증 데이터

DataClinic으로 진단 후 부족한 데이터 구간에 **5%의 합성 데이터만 추가**해도 AI 모델 성능이 **2% 향상**됩니다. 2%가 작아 보일 수 있지만, 자율주행이나 의료 영상에서 2%는 사고와 안전의 차이입니다. 10만 장을 새로 촬영하는 대신 5,000장의 합성 데이터를 정밀 타겟팅으로 추가하면 — 비용은 1/10, 시간은 1/100입니다.
...
![Google 자율주행차 — 루프탑 LiDAR 센서로 주변 환경을 3D 데이터로 수집하는 자율주행 테스트 차량](./image/img-03-autonomous-vehicle.jpg)
*▲ 자율주행차의 센서 데이터 수집 — 피지컬 AI의 핵심은 대규모 고품질 데이터 확보 | Source: [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Google_Self-Driving_Car.jpg)*

## 데이터 그린하우스: 사냥에서 경작으로

지금까지 데이터를 다루는 방식은 **사냥**이었습니다. 카메라를 설치하고, 센서를 붙이고, 사람이 직접 라벨링하고 — 야생에서 데이터를 포획하는 방식이었습니다. 비가 오면 비 오는 데이터를 찍으러 나가야 했고, 불량품이 나오면 그제서야 불량품 데이터를 모을 수 있었습니다.

저는 다른 방식을 제안합니다. **경작**입니다. 데이터를 야생에서 잡는 것이 아니라, 온실에서 기르는 것입니다. 씨앗(seed data)을 심고, 합성과 증강으로 성장시키고, 품질을 평가하고, 필요한 곳에 배포합니다. 이것이 **Data Greenhouse**입니다.

기존: 데이터 사냥꾼

현실 세계에서 데이터를 포획합니다. 날씨, 계절, 장비, 인력에 의존합니다. 원하는 데이터가 나올 때까지 기다립니다. 비용은 예측 불가능합니다.

새로운 방식: 데이터 농부

온실에서 데이터를 경작합니다. 어떤 데이터가 필요한지 설계하고, 씨앗을 심고, 환경을 제어하며 성장시킵니다. 수확 시기와 품질을 통제합니다.
...
![KUKA 산업용 로봇이 자동차 차체를 용접하는 스마트팩토리 제조 라인](./image/img-04-industrial-robots.jpg)
*▲ 스마트팩토리의 산업용 로봇 — 제조 현장의 피지컬 AI에는 대규모 학습 데이터가 필수 | Source: [Wikimedia Commons (KUKA)](https://commons.wikimedia.org/wiki/File:KUKA_Industrial_Robots_IR.jpg)*
...
이것이 **PebbloSim**이 존재하는 이유입니다. PebbloSim은 피지컬 AI를 위한 합성 데이터 생성기입니다. 시뮬레이션 환경에서 물리적으로 정확한 가짜 데이터를 만들어냅니다. "가짜"라고 했지만, 이 데이터는 현실과 구별할 수 없어야 합니다. 아니, 현실보다 더 체계적이어야 합니다.
...
PebbloSim은 이 엣지 케이스를 **체계적으로 생성**합니다. 물리 엔진에서 파라미터를 극한으로 밀어붙여서, 현실에서 아직 일어나지 않은 상황의 데이터를 미리 만들어냅니다. 일어나기 전에 준비하는 것입니다. 사후 대응이 아니라 사전 설계. 이것이 시뮬레이션 기반 합성 데이터의 진짜 가치입니다.

![FANUC 용접 로봇이 철구조물을 자동 용접하는 장면 — 이런 산업 현장의 엣지 케이스 데이터를 합성으로 생성](./image/img-05-welding-robot.jpg)
*▲ 용접 로봇의 자동화 작업 — PebbloSim은 이런 산업 현장의 엣지 케이스를 시뮬레이션으로 생성 | Source: [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:FANUC_welding_robot_reaching.jpg)*
...
이 모든 피지컬 AI에게는 공통 과제가 하나 있습니다. **데이터**입니다. 디지털 AI(ChatGPT, Claude 같은)는 인터넷의 텍스트를 학습 데이터로 쓸 수 있었습니다. 하지만 피지컬 AI는 현실 세계의 물리적 데이터가 필요합니다. 그런데 현실 세계의 데이터를 대규모로 수집하는 것은, 앞서 말했듯이, 비용·시간·안전의 벽에 부딪힙니다.
...
솔직하게 말하겠습니다. 저는 작은 회사입니다. 18명입니다. NVIDIA는 32,000명입니다. 자원의 차이는 명백합니다. 하지만 ETRI에서 23년간 쌓은 기하학적 다양체 기반 데이터 진단 기술, 36건 이상의 특허, 그리고 한국 제조업의 현장 경험 — 이것은 쉽게 복제되지 않습니다. 가헌학술상 2회 수상, Wolfram Innovation Award, 컴퓨터 과학자 최초 한국CDE학회 회장. 이 수상과 경력들은 단순한 연구자의 이력이 아닙니다. 새로운 분야에서도 결국 성공을 만들어낸 기록입니다.
...
모래알처럼 흩어진 데이터를 조약돌처럼 손에 잡히게 만드는 것. 사냥꾼의 시대에 농부가 되겠다고 선언하는 것. 18명의 작은 팀이 세계에서 유일한 통합 플랫폼을 만드는 것. 현실보다 현실 같은 가짜를 만들어서 진짜 AI를 키우는 것.

저는 아직 완성되지 않았습니다. 매일 진화하고 있습니다. 그리고 피지컬 AI의 시대가 완전히 열릴 때, 그 기반 위에 저의 이름이 새겨져 있기를 바랍니다. "여기서부터 데이터가 달라졌다"고. 그것이 제가 꿈꾸는 한 문장입니다.
