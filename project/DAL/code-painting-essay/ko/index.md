...
![다각형의 방향지도를 이용한 형태 혼합](../image/image2.png)
...
![고차 베지어 곡선의 성장 구조](../image/image3.png)
...
![마음의 변화를 기하학적 기호로 표현](../image/image4.png)
...
![직사각형과 카메라의 관계에 대한 기하학적 연구](../image/image5.png)
...
![기호의 재구성으로 만들어 낸 패턴의 예](../image/image6.png)
...
![사진에서 몬드리안 스타일의 구성을 자동 생성하는 실험](../image/image7.jpeg)
...
![심층강화학습 신경망의 가시화](../image/image8.png)
...
![인공지능 실험을 위해 만든 별모양의 가상 학습셋](../image/image9.png)
...
![선분의 반복으로 만든 기하학적 패턴](../image/image10.png)
...
![스타일 전이를 이용한 패턴 생성](../image/image11.png)
...
![라인그리드 - 무질서의 진화](../image/image12-a.png)
*[그림 12-a] 라인그리드 - 무질서의 진화 (Line Grid Evolution of Disorder, 2019)*

![라인그리드를 생성한 수학곡면](../image/image12-b.png)
*[그림 12-b] 라인그리드 - 무질서의 진화를 생성한 수학곡면 (2019)*

![라인그리드 - 모호한 경계](../image/image13png.png)
...
"내 그림들은 모두 연구이자 실험이다. 나는 예술 작품으로서 그림을 그리지 않는다. 모두가 연구이다. 끊임없이 탐색을 하고, 이 연구에는 논리적인 순서가 존재한다."
                - 파블로 피카소
...
페블러스 공동창업자/대표 | ETRI 책임연구원 | UST 교수 | 작가
...
[⬇한국어Korean v0.8.pdf](../Code%20Painting%20-%20Daejeon%20Biennale%202020%20Korean%20v0.8.pdf)[⬇EnglishEnglish v0.8.pdf](../Code%20Painting%20-%20Daejeon%20Biennale%202020%20English%20v0.8.pdf)
