---
title: 피지컬 AI를 위한 데이터,<br>사냥할 것인가 재배할 것인가?
subtitle: 페블러스가 제안하는 
date: 2026년 1월 13일
category: tech
source: index.html
...
# 피지컬 AI를 위한 데이터,<br>사냥할 것인가 재배할 것인가?
...
> [!callout]
> 피지컬 AI(Physical AI)의 시대가 도래했지만, 자율주행차 충돌, 로봇 오작동, 재난 현장 데이터 등 AI 안전에 필수적인 '희귀 데이터(Edge Case)'는 현실에서 수집이 불가능합니다. 이 '데이터 기근(Data Famine)' 문제를 해결하기 위해 페블러스는 데이터를 '사냥'하는 대신 '재배'하는 새로운 패러다임을 제안합니다.

> 페블러스의 데이터 그린하우스(Data Greenhouse)는 디지털 트윈 기반 가상 환경에서 필요한 데이터를 의도적으로 생성합니다. 핵심 실행 엔진인 PebbloSim은 물리 시뮬레이션 위에 생성 AI를 결합하는 '뉴로-심볼릭' 접근으로, 물리적 환각(Physical Hallucination) 없는 고품질 합성 데이터를 생산합니다.

> 데이터 그린하우스는 관측-처방-행동-증명의 자율 운영 체계로 ISO 5259 기반 데이터 품질 진단부터 EU AI Act, ISO 42001 규제 대응까지 전 과정을 '운영 증거(Operational Evidence)'로 기록합니다. 현재 자동차, 국방, 조선, 로보틱스 분야의 선도 기업들과 함께 데이터의 미래를 검증하고 있습니다.
...
| 제어력 | "빗길 사고" (모호한 텍스트) | 마찰계수 0.3, 충돌각 45도 (정밀한 수치) |
...
특히 과학기술정보통신부의 **'AI 글로벌 빅테크 육성사업'** 주관으로 수행 중인 **AADS(Agentic AI Data Scientist) 2단계 과제**에서는 피지컬 AI 분야의 데이터를 핵심 타겟으로 삼고 있습니다. 멀티모달 합성데이터 생성 기술과 제조 산업 특화 **소버린 VLM(Vision-Language Model)** 개발을 통해, 대한민국 제조 강국의 AI 경쟁력을 한 단계 끌어올리고자 합니다.
...
[바로 보기](/project/PhysicalAI/source/pebblous-physical-ai-vision.pdf)[PDF 다운로드](/project/PhysicalAI/source/pebblous-physical-ai-vision.pdf)
