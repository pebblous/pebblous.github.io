 ...
 *
 * ⚠ 2026-07-10: 일상 편집·미리보기는 제목 검토 콘솔(engine /admin/titles)로 통합됨 —
 *   콘솔 상세 패널이 현재 커버 썸네일 + 편집 문구 라이브 프리뷰(POST /articles/og-preview)를
 *   제공하고, 적용은 PR+OG 재생성까지 자동. 이 서버는 "디자인 변경 후 전수 시각 검수" 배치
 *   시나리오에서만 쓴다. 여기서의 편집은 push되지 않음에 유의.
 *
