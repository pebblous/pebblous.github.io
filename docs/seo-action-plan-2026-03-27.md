...
## UrbanGPT 패턴 복제 전략 (2026-04-06 추가)

> UrbanGPT EN 페이지가 110개국 2,400+ 방문, CTR 21~55%를 달성한 성공 공식을 재현 가능한 시스템으로.

### 성공 공식

```
바이럴 모멘트(외부) + 정보 격차 선점(우리) + 글로벌 영문 콘텐츠 = 110개국 트래픽
```

### 4축 실행 프레임워크

**축 1: 소재 발굴** — "AI + 버티컬 도메인 신제품"이 소셜에서 바이럴 직전 단계인 것을 포착. GitHub Trending, ProductHunt, arXiv 주 1회 스캔.

**축 2: EN 퍼스트** — 트렌드 소재는 EN 먼저 48h 내 발행 → KO 후속. 영문 1개 = 110개국 도달.

**축 3: 페블러스 연결** — 외부 제품 분석 → "데이터 품질 전문가 관점"으로 DataClinic/AADS 자연스럽게 연결. 억지 홍보 금지.

**축 4: 시리즈화** — 1회성이 아닌 "vs 비교", "데이터 품질 분석", "PebbloPedia 개념 설명"으로 후속 콘텐츠 확장.

### 실행 루프

```
[주간] 소재 스캔 → 바이럴 감지 → 48h 내 EN 발행 → KO 후속
[발행 시] CTA 자동 삽입 + 페블러스 관점 연결
[발행 후] 후속 콘텐츠 1-2개 기획 → 시리즈화
[격주] GSC 데이터 리뷰 → 신규 키워드 기회 포착
```
...
| 스킬 | 참조 내용 |
|------|----------|
| `blog-research` | 소재 발굴 시 UrbanGPT 패턴 체크, 고CTR 키워드 활용, 정보 격차 확인 |
| `blog-produce` | EN 퍼스트 전략, 페블러스 연결, 후속 시리즈 기획 |
| `blog-publish` | CTA 전략, 페블러스 연결 확인 |
