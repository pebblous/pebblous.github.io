...
| [openapi.yaml](openapi.yaml) | REST API 스펙 — 13 엔드포인트, 11 스키마 |
| [mcp-tools.md](mcp-tools.md) | MCP 인터페이스 스펙 — 9개 툴 |
| [design.md](design.md) | Pipeline Engine 설계 — 파이프라인 정의, 상태 머신, 워크스페이스 레이아웃 |
