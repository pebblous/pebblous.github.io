---
name: story-style-guide
description: 스토리 포스트 표준 스타일 가이드
---
...
- [ ] Publisher: `(주)페블러스 데이터 커뮤니케이션팀` (정식 법인 명칭)
...
## 1. CSS 링크 (순서 고정 — `html-conventions.md` 참조)

```html
<!-- css/styles.css는 인덱스 전용 — 아티클에 포함 금지 -->
...
- publisher 누락 또는 약식 표기 → `(주)페블러스 데이터 커뮤니케이션팀`
