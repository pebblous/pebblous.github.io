...
2. **mainTitle 작성 절차** (본문을 다 쓴 뒤):
   ...
   ④ 제목에서 뺀 **기관·수치·방법·출처는 subtitle로 내린다**(40~70자, 신문체, 명사 종결 허용). 제목이 쉬워진 만큼 부제가 정확해야 한다.
   ...
   - **낯선 고유명사·전문용어** — 회사명·모델명·업계 용어는 subtitle로. AI·SNS·로봇처럼 중학생이 아는 말만. 실패 예 "루마필드 CT 검사 AI" · "에이전트 메모리" · "모더레이션"
...
| `subtitle` | **정확한 헤드라인 자리** — 기관·수치·방법·출처를 신문체로. mainTitle에 없는 보조 키워드 포함. 예: 제목 "SNS 유해 글 단속, 열에 여덟은 딱지 없이 통과" → 부제 "블루스카이 2025년 라벨 1,060만 건 첫 외부 감사 — 정밀도 0.837, 재현율 0.222" | 40~70자 |
