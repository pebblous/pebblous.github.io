...
- **LinkedIn (KO)**: 역피라미드 신문기사형. 가장 센 사실 1문장으로 시작 → 메커니즘/맥락 2~3문장 → 한계/그림자 2문장 → 결론 1문장. **불릿 없이 산문**. 볼드 소제목 금지. 수치는 가장 충격적인 것 1~2개만. 총 5~7문장.
  템플릿:
  ```
  [훅 — 숫자 또는 사건 1문장]
  ...
  #태그
  ```
- **LinkedIn (EN)**: 같은 역피라미드 구조. 직역 금지 — *Reuters* / *FT* 뉴스 리드 톤으로 재작성. EN 블로그 링크 사용.
