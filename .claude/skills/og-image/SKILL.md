...
**커버에 그릴 문구(제목·부제)의 문체 정본은 [`docs/ko-style-standard.md`](../../../docs/ko-style-standard.md) §4-2 v3(2026-09-13 형님 판정 — 두 시험·세 형태, 과거형 종결·제목 안 수치 금지), 커버 슬롯 규칙은 [`docs/title-strategy.md`](../../../docs/title-strategy.md) §1.1** —
