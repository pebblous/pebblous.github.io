---
title: AI 도구를 쓰는 것과 데이터를 기르는 것은 다르다
subtitle: AI 도구와 데이터 그린하우스를 가르는 네 가지 축
date: 2026-06-09
category: tech
source: index.html
...
# AI 도구를 쓰는 것과 데이터를 기르는 것은 다르다

_AI 도구와 데이터 그린하우스를 가르는 네 가지 축_
...
![눈 속에서 사냥을 마치고 돌아오는 사냥꾼들 — 한 번의 사냥으로 잡아 온 빈약한 수확을 보여주는 브뤼헐의 그림](./image/img-01-hunters-snow.jpg)
*▲ 사냥을 마치고 돌아오는 사냥꾼들. 잡아 온 한 마리는 곳간에 들어가지만, 들판은 그대로다. | Source: [피터르 브뤼헐, 〈눈 속의 사냥꾼〉 (1565), Wikimedia Commons (Public Domain)](https://commons.wikimedia.org/wiki/File:Pieter_Bruegel_the_Elder_-_Hunters_in_the_Snow_(Winter)_-_Google_Art_Project.jpg)*
...
![해를 등지고 들판에 씨를 뿌리는 농부 — 한 번의 파종 뒤 해와 비와 시간이 대신 키운다는 경작의 은유를 담은 반 고흐의 그림](./image/img-02-sower.jpg)
*▲ 씨를 뿌리는 행위는 작지만, 그다음은 해와 비와 시간이 대신 키운다. | Source: [빈센트 반 고흐, 〈씨 뿌리는 사람〉 (1888), Wikimedia Commons (Public Domain)](https://commons.wikimedia.org/wiki/File:Sower_at_Sunset_-_Vincent_Van_Gogh.jpg)*
...
### 3.2. 시간성 — 한 번 쓰고 끝인가, 다음 사이클을 좋게 하는가
...
![나무 줄기 단면의 나이테 — 작물이 자란 과정이 결과물 옆에 켜켜이 쌓이는 증적(provenance)의 은유](./image/img-03-tree-rings.jpg)
*▲ 나이테는 나무가 어떻게 자랐는지를 단면에 그대로 새긴다. 증적도 결과물 옆에서 그렇게 함께 자란다. | Source: [Wikimedia Commons (CC BY-SA)](https://commons.wikimedia.org/wiki/File:Tree_Trunk_Cross_Section_-_Kolkata_2011-06-04_3687.JPG)*
...
![사철 내내 작물을 길러내는 대형 현대식 온실(그린하우스) — 통제된 환경에서 데이터와 콘텐츠를 기른다는 페블러스 그린하우스의 은유](./image/img-04-greenhouse.jpg)
*▲ 온실은 바깥 날씨에 수확을 맡기는 대신, 통제된 환경 안에서 사철 내내 길러낸다. | Source: [Rob Oo, Wikimedia Commons (CC BY 2.0)](https://commons.wikimedia.org/wiki/File:Greenhouse_alley_-_Flickr_-_Rob_Oo.jpg)*

페블러스가 그리는 세 개의 그린하우스(콘텐츠, 데이터, 에이전트)는 서로 다른 작물이 아니라 같은 운영 철학으로 가꾸는 세 개의 밭입니다. 콘텐츠도, 데이터도, 그 위에서 일하는 에이전트도 한 번 잡아 오는 사냥감이 아니라 조건을 갖춰 기르는 작물로 다룹니다. 실제로 이 글을 비롯한 페블러스 블로그가 그런 흐름 위에서 자랍니다. 같은 은유를 데이터 수집과 합성의 관점에서 다룬 자매 글
                        [피지컬 AI를 위한 데이터, 사냥할 것인가 재배할 것인가](/project/PhysicalAI/data-greenhouse-vision.html)도 같은 땅에서 나온 이야기입니다.
