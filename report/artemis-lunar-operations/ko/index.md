---
title: 달이 착륙지에서 운영지로 바뀌는 순간
subtitle: 아르테미스가 열어젖힌 달 인프라 패권 경쟁 — 통신·항법·자원의 새로운 전장
date: 2026-04-15
category: tech
source: index.html
...
# 달이 착륙지에서 운영지로 바뀌는 순간

_아르테미스가 열어젖힌 달 인프라 패권 경쟁 — 통신·항법·자원의 새로운 전장_
...
> 한국은 아르테미스 협정 가입국이고, 우주항공청은 2029년 달 통신 궤도선 발사를 선언했다. 그러나 일본(월면차), 캐나다(로봇 팔)처럼 구체적인 역할을 확보한 파트너와 달리, 한국의 포지션은 아직 공백이다. 이 보고서는 달 운영 체계 경쟁의 기술·지정학·비즈니스 구조를 분석하고, 한국이 찾아야 할 전략적 위치를 제안한다. 이 글은 [피지컬 AI](/project/PhysicalAI/ko/) 시리즈의 우주 인프라 편으로, 로봇과 데이터 인프라가 지구 밖에서 어떻게 운영되는지를 보는 자리다.
